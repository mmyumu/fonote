...
- Actions paired gesture by gesture, success above, failure below: good/bad, goal/own goal, pass/missed pass, dribble/failed dribble, shot on target/shot off target, defensive action/lost duel, then lost ball, yellow, red. Each carries a weight; polarity, colour and summary follow from it, instead of being picked by hand.
- **A cell may hold a family**, marked by a small corner: a tap gives the common gesture, a long press lays out the others above the cell, the way a keyboard offers its accents — slide onto one and lift, or lift first and tap. « Passe » holds « Passe D » (assist); « Défense » holds « Tacle » (tackle) and « Interception ». The cell shows the member the player was given, so that « Passe D » can be read at a glance; going back to a plain pass goes through the long press.
